#Week 3 | Team Activity - Grade Calculator Program
"""
...
if user_grade_percentage == a or user_grade_percentage == b :
    print("Congratlations, you passed in this term! Keep up the good work on your further studies!")
else :
    print("Unfortunutaly, you did not pass in this term. Don't give up, we encourage you to talk to yor mentor who could give you some advice on your further studies.")
"""
